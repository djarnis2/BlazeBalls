...
public class SuperEnemyControlSystem implements IEntityProcessingService {
    private static final float ROTATION_MAX = 10f; // angle degrees per second
    private static final float MOVEMENT_SPEED = 75f; // units per second
